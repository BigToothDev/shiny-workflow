...
df_ukr_pop_redion_all_flows = pd.read_csv('./app_files/ukr_pop_region_all_flows_total.csv', sep=",", decimal=".")
with open('./app_files/UA_FULL_Ukraine.geojson', 'r', encoding='utf-8') as geo_file:
    ...
    ui.page_navbar(
        ...
        ui.nav_panel("Ukraine migration: mapping",
            ui.input_selectize("selectize_migration_region", "Select flow:", {
                "all_flows": "All migration flows 2021",
                "interstate_flows": "Inter-state migration flows 2021"
            },
                selected="all_flows"
            ),
...
def server(input, output, session):
    ...
    def create_migration_map():
        trace = go.Choroplethmapbox(
            ...
            locations=df_ukr_pop_redion_all_flows['Region'],
            z=df_ukr_pop_redion_all_flows['migration increase (decrease)'],
        ...
        layout = go.Layout(
            ...
            title="Migration Increase/Decrease by Region (Ukraine)",
